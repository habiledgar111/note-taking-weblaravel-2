                        ...
                        <div class="p-5">
                            ...
                            <form  action="<?php echo e(url('/actionregister')); ?>" method="post" class="user">
                               ...
                               <div class="form-group">
                                ...
                                <a href="<?php echo e(url('/')); ?>" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </a>
                            </form>
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?php echo e(url('/')); ?>">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\ASUS\Videos\note-taking-weblaravel--master\resources\views/register.blade.php ENDPATH**/ ?>